...
// Add meta box only when the 'About Page' template is selected
    ...
    if ($template === 'page-templates/about.php') {
        add_meta_box(
            ...
            function($post) {
                ...
                // JavaScript and CSS for tabs and image selection
                ?>
                <script>
                jQuery(document).ready(function($) {
                    ...
                    $('.select-images').click(function(e) {
                        ...
                        mediaUploader.on('select', function() {
                            ...
                            var imageIds = attachments.map(att => att.id);
                ...
                .select-images { margin-left: 10px; }
                </style>
                <?php
            },
            'page',
